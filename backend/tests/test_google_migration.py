...
class TestGoogleMigration(unittest.TestCase):
    ...
    def test_google_sdk_client(self):
        ...
        # If Client() validates the key immediately, this might fail, so we
        # might need to patch the Client class.
    ...
    def test_analyze_heavy_logs(self, mock_get_client):
        ...
        result = analyze_heavy_logs.invoke(
            {"log_content": "Error: connection failed", "context": "test"})
